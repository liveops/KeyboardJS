...
function KeyCombo(o){var e=this;guard("keyComboStr",o,"string"),e.sourceStr=o,e.subCombos=KeyCombo.parseComboStr(o),e.keyNames=e.subCombos.reduce(function(o,e){return o.concat(e)})}var guard=require("type-guard");KeyCombo.sequenceDeliminator=">>",KeyCombo.comboDeliminator=">",KeyCombo.keyDeliminator="+",KeyCombo.parseComboStr=function(o){guard("keyComboStr",o,"string");for(var e=KeyCombo._splitStr(o,KeyCombo.comboDeliminator),r=[],t=0;t<e.length;t+=1)r.push(KeyCombo._splitStr(e[t],KeyCombo.keyDeliminator));return r},KeyCombo.prototype.check=function(o){var e=this;guard("pressedKeyNames",o,"array");for(var r=0,t=0;t<e.subCombos.length;t+=1)if(r=e._checkSubCombo(e.subCombos[t],r,o),-1===r)return!1;return!0},KeyCombo.prototype.isEqual=function(o){var e=this;if(guard("otherKeyCombo",o,["object","string"]),"string"==typeof o?o=new KeyCombo(o):guard("otherKeyCombo.subCombos",o.subCombos,"array"),e.subCombos.length!==o.subCombos.length)return!1;for(var r=0;r<e.subCombos.length;r+=1)if(e.subCombos[r].length!==o.subCombos[r].length)return!1;for(var r=0;r<e.subCombos.length;r+=1){for(var t=e.subCombos[r],b=o.subCombos[r].slice(0),s=0;s<t.length;s+=1){var m=t[s],n=b.indexOf(m);n>-1&&b.splice(n,1)}if(0!==b.length)return!1}return!0},KeyCombo._splitStr=function(o,e){for(var r=o,t=e,b="",s=[],m=0;m<r.length;m+=1)m>0&&r[m]===t&&"\\"!==r[m-1]&&(s.push(b.trim()),b="",m+=1),b+=r[m];return b&&s.push(b.trim()),s},KeyCombo.prototype._checkSubCombo=function(o,e,r){guard("subCombo",o,"array"),guard("startingKeyNameIndex",e,"number"),guard("pressedKeyNames",r,"array"),o=o.slice(0),r=r.slice(e);for(var t=e,b=0;b<o.length;b+=1){var s=o[b];if("\\"===s[0]){var m=s.slice(1);(m===KeyCombo.comboDeliminator||m===KeyCombo.keyDeliminator)&&(s=m)}var n=r.indexOf(s);if(n>-1&&(o.splice(b,1),b-=1,n>t&&(t=n),0===o.length))return t}return-1},module.exports=KeyCombo;
},{"type-guard":6}],3:[function(require,module,exports){
(function(e){function n(e){var n=this;t("targetWindow",e,["object","undefined"]),n.locale=null,n._currentContext=null,n._contexts={},n._listeners=[],n._appliedListeners=[],n._locales={},n._targetDocument=null,n._targetWindow=null,n.setContext("default"),n.watch()}var t=require("type-guard"),r=require("./locale"),o=require("./key-combo");n.prototype.setLocale=function(e,n){var o=this,l=null;"string"==typeof e?(t("localeName",e,["string","null"]),t("localeBuilder",n,["function","undefined"]),n?(l=new r(e),n(l)):l=o._locales[e]||null):(t("locale",e,"object"),t("locale.localeName",e.localeName,"string"),t("locale.pressKey",e.pressKey,"function"),t("locale.releaseKey",e.releaseKey,"function"),t("locale.pressedKeys",e.pressedKeys,"array"),l=e,e=l.localeName),o.locale=l,o._locales[e]=l,l&&(o.locale.pressedKeys=l.pressedKeys)},n.prototype.getLocale=function(e){var n=this;return e||(e=n.locale.localeName),n._locales[e]||null},n.prototype.bind=function(e,n,r){var l=this;if(t("keyComboStr",e,["string","array"]),t("pressHandler",n,["function","undefined","null"]),t("releaseHandler",r,["function","undefined","null"]),"string"==typeof e)l._listeners.push({keyCombo:new o(e),pressHandler:n||null,releaseHandler:r||null,preventRepeat:!1});else for(var s=0;s<e.length;s+=1)l.bind(e[s],n,r)},n.prototype.addListener=n.prototype.bind,n.prototype.on=n.prototype.bind,n.prototype.unbind=function(e,n,r){var o=this;if(t("keyComboStr",e,["string","array"]),t("pressHandler",n,["function","undefined"]),t("releaseHandler",r,["function","undefined"]),"string"==typeof e)for(var l=0;l<o._listeners.length;l+=1){var s=o._listeners[l],i=s.keyCombo.isEqual(e),a=!n||n===s.pressHandler,d=null===s.releaseHandler||r===s.releaseHandler;i&&a&&d&&(o._listeners.splice(l,1),l-=1)}else for(var l=0;l<e.length;l+=1)o.bind(e[l],n,r)},n.prototype.removeListener=n.prototype.unbind,n.prototype.off=n.prototype.unbind,n.prototype.setContext=function(e){var n=this;t("contextName",e,"string"),n.locale&&n.releaseAllKeys(),n._contexts[e]||(n._contexts[e]=[]),n._listeners=n._contexts[e],n._currentContext=e},n.prototype.getContext=function(){var e=this;return e._currentContext},n.prototype.watch=function(n,r){var o=this;t("targetDocument",n,["object","undefined"]),t("targetWindow",r,["object","undefined"]),o.stop(),n&&n.document&&!r&&(r=n,n=null),r||(r=e.window),r&&!n&&(n=r.document),n&&r&&(o._isModernBrowser=!!r.addEventListener,o._bindEvent(n,"keydown",function(e){o.pressKey(e.keyCode,e)}),o._bindEvent(n,"keyup",function(e){o.releaseKey(e.keyCode,e)}),o._bindEvent(r,"focus",o.releaseAllKeys.bind(o)),o._bindEvent(r,"blur",o.releaseAllKeys.bind(o)),o._targetDocument=n,o._targetWindow=r)},n.prototype.stop=function(){var e=this;e._targetDocument&&(e._unbindEvent(e._targetDocument,"keydown",function(n){e.pressKey(n.keyCode,n)}),e._unbindEvent(e._targetDocument,"keyup",function(n){e.releaseKey(n.keyCode,n)}),e._targetDocument=null),e._targetWindow&&(e._unbindEvent(e._targetWindow,"focus",e.releaseAllKeys.bind(e)),e._unbindEvent(e._targetWindow,"blur",e.releaseAllKeys.bind(e)),e._targetWindow=null)},n.prototype.pressKey=function(e,n){var r=this;t("keyCode",e,["number","string"]),t("event",n,["object","undefined"]),r.locale.pressKey(e),r._applyBindings(n)},n.prototype.releaseKey=function(e,n){var r=this;t("keyCode",e,["number","string"]),t("event",n,["object","undefined"]),r.locale.releaseKey(e),r._clearBindings(n)},n.prototype.releaseAllKeys=function(){var e=this;e.locale.pressedKeys.length=0,e._clearBindings()},n.prototype.reset=function(){var e=this;e.releaseAllKeys(),e._listeners.length=0},n.prototype._bindEvent=function(e,n,t){var r=this;return r._isModernBrowser?e.addEventListener(n,t,!1):e.attachEvent("on"+n,t)},n.prototype._unbindEvent=function(e,n,t){var r=this;return r._isModernBrowser?e.removeEventListener(n,t,!1):e.detachEvent("on"+n,t)},n.prototype._getGroupedListeners=function(){var e=this,n=[],t=[];return e._listeners.slice(0).sort(function(e,n){return e.keyCombo.keyNames.length>n.keyCombo.keyNames.length}).forEach(function(e){for(var r=-1,o=0;o<t.length;o+=1)t[o].isEqual(e.keyCombo)&&(r=o);-1===r&&(r=t.length,t.push(e.keyCombo)),n[r]||(n[r]=[]),n[r].push(e)}),n},n.prototype._applyBindings=function(e){var n=this;e||(e={});var t=!1;e.preventRepeat=function(){t=!0};for(var r=n.locale.pressedKeys.slice(0),o=n._getGroupedListeners(),l=0;l<o.length;l+=1){var s=o[l],i=s[0].keyCombo;if(i.check(r)){for(var a=0;a<s.length;a+=1){var d=s[a],p=d.pressHandler;p&&!d.preventRepeat&&(p.call(n,e),t&&(d.preventRepeat=t,t=!1)),d.releaseHandler&&-1===n._appliedListeners.indexOf(d)&&n._appliedListeners.push(d)}for(var a=0;a<i.keyNames.length;a+=1){var u=r.indexOf(i.keyNames[a]);-1!==u&&(r.splice(u,1),a-=1)}}}},n.prototype._clearBindings=function(e){var n=this;e||(e={});for(var t=0;t<n._appliedListeners.length;t+=1){var r=n._appliedListeners[t],o=r.keyCombo,l=r.releaseHandler;o.check(n.locale.pressedKeys)||(r.preventRepeat=!1,l.call(n,e),n._appliedListeners.splice(t,1),t-=1)}},module.exports=n}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{});
